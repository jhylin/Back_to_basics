...
* Run rmarkdown::run("1_Using_r_in_python.rmd") in R terminal to preview .rmd 
(although not a good practice to leave install packages code in rmarkdown as if using alternative "Knit Rmd" button to preview, this'll lead to the same error message)