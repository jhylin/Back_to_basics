...
2. Install R's language server. All R packages are to be installed via R console/terminal.
...
```{r}
# Transfer code to read df into a function and saved as a .py script
...
An equivalent Python plotting library based on ggplot2 is [plotnine](https://plotnine.org/).