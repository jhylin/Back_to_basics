...
Essentially, I think there are possibly two packages that may do the trick - one is rpy2 and the other is reticulate. So I'll try rpy2 first in this post. For the notes on using reticulate package, it'll be in a separate post (**add link**).
